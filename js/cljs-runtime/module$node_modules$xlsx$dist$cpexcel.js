shadow$provide.module$node_modules$xlsx$dist$cpexcel = function(global, require, module, exports) {
  var Buffer = require("shadow$empty").Buffer, cptable = {version:"1.15.0"};
  cptable[437] = function() {
    for (var D = [], e = {}, i = 0; 256 != i; ++i) {
      65533 !== "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ÇüéâäàåçêëèïîìÄÅÉæÆôöòûùÿÖÜ¢£¥₧ƒáíóúñÑªº¿⌐¬½¼¡«»░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀αßΓπΣσµτΦΘΩδ∞φε∩≡±≥≤⌠⌡÷≈°∙·√ⁿ²■ ".charCodeAt(i) && (e["\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ÇüéâäàåçêëèïîìÄÅÉæÆôöòûùÿÖÜ¢£¥₧ƒáíóúñÑªº¿⌐¬½¼¡«»░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀αßΓπΣσµτΦΘΩδ∞φε∩≡±≥≤⌠⌡÷≈°∙·√ⁿ²■ ".charAt(i)] = 
      i), D[i] = "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ÇüéâäàåçêëèïîìÄÅÉæÆôöòûùÿÖÜ¢£¥₧ƒáíóúñÑªº¿⌐¬½¼¡«»░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀αßΓπΣσµτΦΘΩδ∞φε∩≡±≥≤⌠⌡÷≈°∙·√ⁿ²■ ".charAt(i);
    }
    return {enc:e, dec:D};
  }();
  cptable[620] = function() {
    for (var D = [], e = {}, i = 0; 256 != i; ++i) {
      65533 !== "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ÇüéâäàąçêëèïîćÄĄĘęłôöĆûùŚÖÜ¢Ł¥śƒŹŻóÓńŃźż¿⌐¬½¼¡«»░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀αßΓπΣσµτΦΘΩδ∞φε∩≡±≥≤⌠⌡÷≈°∙·√ⁿ²■ ".charCodeAt(i) && (e["\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ÇüéâäàąçêëèïîćÄĄĘęłôöĆûùŚÖÜ¢Ł¥śƒŹŻóÓńŃźż¿⌐¬½¼¡«»░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀αßΓπΣσµτΦΘΩδ∞φε∩≡±≥≤⌠⌡÷≈°∙·√ⁿ²■ ".charAt(i)] = 
      i), D[i] = "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ÇüéâäàąçêëèïîćÄĄĘęłôöĆûùŚÖÜ¢Ł¥śƒŹŻóÓńŃźż¿⌐¬½¼¡«»░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀αßΓπΣσµτΦΘΩδ∞φε∩≡±≥≤⌠⌡÷≈°∙·√ⁿ²■ ".charAt(i);
    }
    return {enc:e, dec:D};
  }();
  cptable[737] = function() {
    for (var D = [], e = {}, i = 0; 256 != i; ++i) {
      65533 !== "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ΑΒΓΔΕΖΗΘΙΚΛΜΝΞΟΠΡΣΤΥΦΧΨΩαβγδεζηθικλμνξοπρσςτυφχψ░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀ωάέήϊίόύϋώΆΈΉΊΌΎΏ±≥≤ΪΫ÷≈°∙·√ⁿ²■ ".charCodeAt(i) && (e["\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ΑΒΓΔΕΖΗΘΙΚΛΜΝΞΟΠΡΣΤΥΦΧΨΩαβγδεζηθικλμνξοπρσςτυφχψ░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀ωάέήϊίόύϋώΆΈΉΊΌΎΏ±≥≤ΪΫ÷≈°∙·√ⁿ²■ ".charAt(i)] = 
      i), D[i] = "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ΑΒΓΔΕΖΗΘΙΚΛΜΝΞΟΠΡΣΤΥΦΧΨΩαβγδεζηθικλμνξοπρσςτυφχψ░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀ωάέήϊίόύϋώΆΈΉΊΌΎΏ±≥≤ΪΫ÷≈°∙·√ⁿ²■ ".charAt(i);
    }
    return {enc:e, dec:D};
  }();
  cptable[850] = function() {
    for (var D = [], e = {}, i = 0; 256 != i; ++i) {
      65533 !== "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ÇüéâäàåçêëèïîìÄÅÉæÆôöòûùÿÖÜø£Ø×ƒáíóúñÑªº¿®¬½¼¡«»░▒▓│┤ÁÂÀ©╣║╗╝¢¥┐└┴┬├─┼ãÃ╚╔╩╦╠═╬¤ðÐÊËÈıÍÎÏ┘┌█▄¦Ì▀ÓßÔÒõÕµþÞÚÛÙýÝ¯´­±‗¾¶§÷¸°¨·¹³²■ ".charCodeAt(i) && (e["\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ÇüéâäàåçêëèïîìÄÅÉæÆôöòûùÿÖÜø£Ø×ƒáíóúñÑªº¿®¬½¼¡«»░▒▓│┤ÁÂÀ©╣║╗╝¢¥┐└┴┬├─┼ãÃ╚╔╩╦╠═╬¤ðÐÊËÈıÍÎÏ┘┌█▄¦Ì▀ÓßÔÒõÕµþÞÚÛÙýÝ¯´­±‗¾¶§÷¸°¨·¹³²■ ".charAt(i)] = 
      i), D[i] = "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ÇüéâäàåçêëèïîìÄÅÉæÆôöòûùÿÖÜø£Ø×ƒáíóúñÑªº¿®¬½¼¡«»░▒▓│┤ÁÂÀ©╣║╗╝¢¥┐└┴┬├─┼ãÃ╚╔╩╦╠═╬¤ðÐÊËÈıÍÎÏ┘┌█▄¦Ì▀ÓßÔÒõÕµþÞÚÛÙýÝ¯´­±‗¾¶§÷¸°¨·¹³²■ ".charAt(i);
    }
    return {enc:e, dec:D};
  }();
  cptable[852] = function() {
    for (var D = [], e = {}, i = 0; 256 != i; ++i) {
      65533 !== "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ÇüéâäůćçłëŐőîŹÄĆÉĹĺôöĽľŚśÖÜŤťŁ×čáíóúĄąŽžĘę¬źČş«»░▒▓│┤ÁÂĚŞ╣║╗╝Żż┐└┴┬├─┼Ăă╚╔╩╦╠═╬¤đĐĎËďŇÍÎě┘┌█▄ŢŮ▀ÓßÔŃńňŠšŔÚŕŰýÝţ´­˝˛ˇ˘§÷¸°¨˙űŘř■ ".charCodeAt(i) && (e["\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ÇüéâäůćçłëŐőîŹÄĆÉĹĺôöĽľŚśÖÜŤťŁ×čáíóúĄąŽžĘę¬źČş«»░▒▓│┤ÁÂĚŞ╣║╗╝Żż┐└┴┬├─┼Ăă╚╔╩╦╠═╬¤đĐĎËďŇÍÎě┘┌█▄ŢŮ▀ÓßÔŃńňŠšŔÚŕŰýÝţ´­˝˛ˇ˘§÷¸°¨˙űŘř■ ".charAt(i)] = 
      i), D[i] = "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ÇüéâäůćçłëŐőîŹÄĆÉĹĺôöĽľŚśÖÜŤťŁ×čáíóúĄąŽžĘę¬źČş«»░▒▓│┤ÁÂĚŞ╣║╗╝Żż┐└┴┬├─┼Ăă╚╔╩╦╠═╬¤đĐĎËďŇÍÎě┘┌█▄ŢŮ▀ÓßÔŃńňŠšŔÚŕŰýÝţ´­˝˛ˇ˘§÷¸°¨˙űŘř■ ".charAt(i);
    }
    return {enc:e, dec:D};
  }();
  cptable[857] = function() {
    for (var D = [], e = {}, i = 0; 256 != i; ++i) {
      65533 !== "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ÇüéâäàåçêëèïîıÄÅÉæÆôöòûùİÖÜø£ØŞşáíóúñÑĞğ¿®¬½¼¡«»░▒▓│┤ÁÂÀ©╣║╗╝¢¥┐└┴┬├─┼ãÃ╚╔╩╦╠═╬¤ºªÊËÈ�ÍÎÏ┘┌█▄¦Ì▀ÓßÔÒõÕµ�×ÚÛÙìÿ¯´­±�¾¶§÷¸°¨·¹³²■ ".charCodeAt(i) && (e["\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ÇüéâäàåçêëèïîıÄÅÉæÆôöòûùİÖÜø£ØŞşáíóúñÑĞğ¿®¬½¼¡«»░▒▓│┤ÁÂÀ©╣║╗╝¢¥┐└┴┬├─┼ãÃ╚╔╩╦╠═╬¤ºªÊËÈ�ÍÎÏ┘┌█▄¦Ì▀ÓßÔÒõÕµ�×ÚÛÙìÿ¯´­±�¾¶§÷¸°¨·¹³²■ ".charAt(i)] = 
      i), D[i] = "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ÇüéâäàåçêëèïîıÄÅÉæÆôöòûùİÖÜø£ØŞşáíóúñÑĞğ¿®¬½¼¡«»░▒▓│┤ÁÂÀ©╣║╗╝¢¥┐└┴┬├─┼ãÃ╚╔╩╦╠═╬¤ºªÊËÈ�ÍÎÏ┘┌█▄¦Ì▀ÓßÔÒõÕµ�×ÚÛÙìÿ¯´­±�¾¶§÷¸°¨·¹³²■ ".charAt(i);
    }
    return {enc:e, dec:D};
  }();
  cptable[861] = function() {
    for (var D = [], e = {}, i = 0; 256 != i; ++i) {
      65533 !== "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ÇüéâäàåçêëèÐðÞÄÅÉæÆôöþûÝýÖÜø£Ø₧ƒáíóúÁÍÓÚ¿⌐¬½¼¡«»░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀αßΓπΣσµτΦΘΩδ∞φε∩≡±≥≤⌠⌡÷≈°∙·√ⁿ²■ ".charCodeAt(i) && (e["\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ÇüéâäàåçêëèÐðÞÄÅÉæÆôöþûÝýÖÜø£Ø₧ƒáíóúÁÍÓÚ¿⌐¬½¼¡«»░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀αßΓπΣσµτΦΘΩδ∞φε∩≡±≥≤⌠⌡÷≈°∙·√ⁿ²■ ".charAt(i)] = 
      i), D[i] = "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ÇüéâäàåçêëèÐðÞÄÅÉæÆôöþûÝýÖÜø£Ø₧ƒáíóúÁÍÓÚ¿⌐¬½¼¡«»░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀αßΓπΣσµτΦΘΩδ∞φε∩≡±≥≤⌠⌡÷≈°∙·√ⁿ²■ ".charAt(i);
    }
    return {enc:e, dec:D};
  }();
  cptable[865] = function() {
    for (var D = [], e = {}, i = 0; 256 != i; ++i) {
      65533 !== "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ÇüéâäàåçêëèïîìÄÅÉæÆôöòûùÿÖÜø£Ø₧ƒáíóúñÑªº¿⌐¬½¼¡«¤░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀αßΓπΣσµτΦΘΩδ∞φε∩≡±≥≤⌠⌡÷≈°∙·√ⁿ²■ ".charCodeAt(i) && (e["\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ÇüéâäàåçêëèïîìÄÅÉæÆôöòûùÿÖÜø£Ø₧ƒáíóúñÑªº¿⌐¬½¼¡«¤░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀αßΓπΣσµτΦΘΩδ∞φε∩≡±≥≤⌠⌡÷≈°∙·√ⁿ²■ ".charAt(i)] = 
      i), D[i] = "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ÇüéâäàåçêëèïîìÄÅÉæÆôöòûùÿÖÜø£Ø₧ƒáíóúñÑªº¿⌐¬½¼¡«¤░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀αßΓπΣσµτΦΘΩδ∞φε∩≡±≥≤⌠⌡÷≈°∙·√ⁿ²■ ".charAt(i);
    }
    return {enc:e, dec:D};
  }();
  cptable[866] = function() {
    for (var D = [], e = {}, i = 0; 256 != i; ++i) {
      65533 !== "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~АБВГДЕЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯабвгдежзийклмноп░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀рстуфхцчшщъыьэюяЁёЄєЇїЎў°∙·√№¤■ ".charCodeAt(i) && (e["\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~АБВГДЕЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯабвгдежзийклмноп░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀рстуфхцчшщъыьэюяЁёЄєЇїЎў°∙·√№¤■ ".charAt(i)] = 
      i), D[i] = "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~АБВГДЕЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯабвгдежзийклмноп░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀рстуфхцчшщъыьэюяЁёЄєЇїЎў°∙·√№¤■ ".charAt(i);
    }
    return {enc:e, dec:D};
  }();
  cptable[874] = function() {
    for (var D = [], e = {}, i = 0; 256 != i; ++i) {
      65533 !== "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~€����…�����������‘’“”•–—�������� กขฃคฅฆงจฉชซฌญฎฏฐฑฒณดตถทธนบปผฝพฟภมยรฤลฦวศษสหฬอฮฯะัาำิีึืฺุู����฿เแโใไๅๆ็่้๊๋์ํ๎๏๐๑๒๓๔๕๖๗๘๙๚๛����".charCodeAt(i) && (e["\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~€����…�����������‘’“”•–—�������� กขฃคฅฆงจฉชซฌญฎฏฐฑฒณดตถทธนบปผฝพฟภมยรฤลฦวศษสหฬอฮฯะัาำิีึืฺุู����฿เแโใไๅๆ็่้๊๋์ํ๎๏๐๑๒๓๔๕๖๗๘๙๚๛����".charAt(i)] = 
      i), D[i] = "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~€����…�����������‘’“”•–—�������� กขฃคฅฆงจฉชซฌญฎฏฐฑฒณดตถทธนบปผฝพฟภมยรฤลฦวศษสหฬอฮฯะัาำิีึืฺุู����฿เแโใไๅๆ็่้๊๋์ํ๎๏๐๑๒๓๔๕๖๗๘๙๚๛����".charAt(i);
    }
    return {enc:e, dec:D};
  }();
  cptable[895] = function() {
    for (var D = [], e = {}, i = 0; 256 != i; ++i) {
      65533 !== "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ČüéďäĎŤčěĚĹÍľǪÄÁÉžŽôöÓůÚýÖÜŠĽÝŘťáíóúňŇŮÔšřŕŔ¼§«»░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀αßΓπΣσµτΦΘΩδ∞φε∩≡±≥≤⌠⌡÷≈°∙·√ⁿ²■ ".charCodeAt(i) && (e["\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ČüéďäĎŤčěĚĹÍľǪÄÁÉžŽôöÓůÚýÖÜŠĽÝŘťáíóúňŇŮÔšřŕŔ¼§«»░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀αßΓπΣσµτΦΘΩδ∞φε∩≡±≥≤⌠⌡÷≈°∙·√ⁿ²■ ".charAt(i)] = 
      i), D[i] = "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ČüéďäĎŤčěĚĹÍľǪÄÁÉžŽôöÓůÚýÖÜŠĽÝŘťáíóúňŇŮÔšřŕŔ¼§«»░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀αßΓπΣσµτΦΘΩδ∞φε∩≡±≥≤⌠⌡÷≈°∙·√ⁿ²■ ".charAt(i);
    }
    return {enc:e, dec:D};
  }();
  cptable[932] = function() {
    var d = [], e = {}, D = [], j;
    D[0] = "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~���������������������������������｡｢｣､･ｦｧｨｩｪｫｬｭｮｯｰｱｲｳｴｵｶｷｸｹｺｻｼｽｾｿﾀﾁﾂﾃﾄﾅﾆﾇﾈﾉﾊﾋﾌﾍﾎﾏﾐﾑﾒﾓﾔﾕﾖﾗﾘﾙﾚﾛﾜﾝﾞﾟ��������������������������������".split("");
    for (j = 0; j != D[0].length; ++j) {
      65533 !== D[0][j].charCodeAt(0) && (e[D[0][j]] = 0 + j, d[0 + j] = D[0][j]);
    }
    D[129] = "����������������������������������������������������������������　、。，．・：；？！゛゜´｀¨＾￣＿ヽヾゝゞ〃仝々〆〇ー―‐／＼～∥｜…‥‘’“”（）〔〕［］｛｝〈〉《》「」『』【】＋－±×�÷＝≠＜＞≦≧∞∴♂♀°′″℃￥＄￠￡％＃＆＊＠§☆★○●◎◇◆□■△▲▽▼※〒→←↑↓〓�����������∈∋⊆⊇⊂⊃∪∩��������∧∨￢⇒⇔∀∃�����������∠⊥⌒∂∇≡≒≪≫√∽∝∵∫∬�������Å‰♯♭♪†‡¶����◯���".split("");
    for (j = 0; j != D[129].length; ++j) {
      65533 !== D[129][j].charCodeAt(0) && (e[D[129][j]] = 33024 + j, d[33024 + j] = D[129][j]);
    }
    ...
    for (j = 0; j != D[130].length; ++j) {
      65533 !== D[130][j].charCodeAt(0) && (e[D[130][j]] = 33280 + j, d[33280 + j] = D[130][j]);
    }
    ...
    for (j = 0; j != D[131].length; ++j) {
      65533 !== D[131][j].charCodeAt(0) && (e[D[131][j]] = 33536 + j, d[33536 + j] = D[131][j]);
    }
    D[132] = "����������������������������������������������������������������АБВГДЕЁЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯ���������������абвгдеёжзийклмн�опрстуфхцчшщъыьэюя�������������─│┌┐┘└├┬┤┴┼━┃┏┓┛┗┣┳┫┻╋┠┯┨┷┿┝┰┥┸╂�����������������������������������������������������������������".split("");
    for (j = 0; j != D[132].length; ++j) {
      65533 !== D[132][j].charCodeAt(0) && (e[D[132][j]] = 33792 + j, d[33792 + j] = D[132][j]);
    }
    D[135] = "����������������������������������������������������������������①②③④⑤⑥⑦⑧⑨⑩⑪⑫⑬⑭⑮⑯⑰⑱⑲⑳ⅠⅡⅢⅣⅤⅥⅦⅧⅨⅩ�㍉㌔㌢㍍㌘㌧㌃㌶㍑㍗㌍㌦㌣㌫㍊㌻㎜㎝㎞㎎㎏㏄㎡��������㍻�〝〟№㏍℡㊤㊥㊦㊧㊨㈱㈲㈹㍾㍽㍼≒≡∫∮∑√⊥∠∟⊿∵∩∪���������������������������������������������������������������������������������������������������".split("");
    for (j = 0; j != D[135].length; ++j) {
      65533 !== D[135][j].charCodeAt(0) && (e[D[135][j]] = 34560 + j, d[34560 + j] = D[135][j]);
    }
    ...
    for (j = 0; j != D[136].length; ++j) {
      65533 !== D[136][j].charCodeAt(0) && (e[D[136][j]] = 34816 + j, d[34816 + j] = D[136][j]);
    }
    ...
    for (j = 0; j != D[137].length; ++j) {
      65533 !== D[137][j].charCodeAt(0) && (e[D[137][j]] = 35072 + j, d[35072 + j] = D[137][j]);
    }
    ...
    for (j = 0; j != D[138].length; ++j) {
      65533 !== D[138][j].charCodeAt(0) && (e[D[138][j]] = 35328 + j, d[35328 + j] = D[138][j]);
    }
    ...
    for (j = 0; j != D[139].length; ++j) {
      65533 !== D[139][j].charCodeAt(0) && (e[D[139][j]] = 35584 + j, d[35584 + j] = D[139][j]);
    }
    ...
    for (j = 0; j != D[140].length; ++j) {
      65533 !== D[140][j].charCodeAt(0) && (e[D[140][j]] = 35840 + j, d[35840 + j] = D[140][j]);
    }
    ...
    for (j = 0; j != D[141].length; ++j) {
      65533 !== D[141][j].charCodeAt(0) && (e[D[141][j]] = 36096 + j, d[36096 + j] = D[141][j]);
    }
    ...
    for (j = 0; j != D[142].length; ++j) {
      65533 !== D[142][j].charCodeAt(0) && (e[D[142][j]] = 36352 + j, d[36352 + j] = D[142][j]);
    }
    ...
    for (j = 0; j != D[143].length; ++j) {
      65533 !== D[143][j].charCodeAt(0) && (e[D[143][j]] = 36608 + j, d[36608 + j] = D[143][j]);
    }
    ...
    for (j = 0; j != D[144].length; ++j) {
      65533 !== D[144][j].charCodeAt(0) && (e[D[144][j]] = 36864 + j, d[36864 + j] = D[144][j]);
    }
    ...
    for (j = 0; j != D[145].length; ++j) {
      65533 !== D[145][j].charCodeAt(0) && (e[D[145][j]] = 37120 + j, d[37120 + j] = D[145][j]);
    }
    ...
    for (j = 0; j != D[146].length; ++j) {
      65533 !== D[146][j].charCodeAt(0) && (e[D[146][j]] = 37376 + j, d[37376 + j] = D[146][j]);
    }
    ...
    for (j = 0; j != D[147].length; ++j) {
      65533 !== D[147][j].charCodeAt(0) && (e[D[147][j]] = 37632 + j, d[37632 + j] = D[147][j]);
    }
    ...
    for (j = 0; j != D[148].length; ++j) {
      65533 !== D[148][j].charCodeAt(0) && (e[D[148][j]] = 37888 + j, d[37888 + j] = D[148][j]);
    }
    ...
    for (j = 0; j != D[149].length; ++j) {
      65533 !== D[149][j].charCodeAt(0) && (e[D[149][j]] = 38144 + j, d[38144 + j] = D[149][j]);
    }
    ...
    for (j = 0; j != D[150].length; ++j) {
      65533 !== D[150][j].charCodeAt(0) && (e[D[150][j]] = 38400 + j, d[38400 + j] = D[150][j]);
    }
    ...
    for (j = 0; j != D[151].length; ++j) {
      65533 !== D[151][j].charCodeAt(0) && (e[D[151][j]] = 38656 + j, d[38656 + j] = D[151][j]);
    }
    ...
    for (j = 0; j != D[152].length; ++j) {
      65533 !== D[152][j].charCodeAt(0) && (e[D[152][j]] = 38912 + j, d[38912 + j] = D[152][j]);
    }
    ...
    for (j = 0; j != D[153].length; ++j) {
      65533 !== D[153][j].charCodeAt(0) && (e[D[153][j]] = 39168 + j, d[39168 + j] = D[153][j]);
    }
    ...
    for (j = 0; j != D[154].length; ++j) {
      65533 !== D[154][j].charCodeAt(0) && (e[D[154][j]] = 39424 + j, d[39424 + j] = D[154][j]);
    }
    ...
    for (j = 0; j != D[155].length; ++j) {
      65533 !== D[155][j].charCodeAt(0) && (e[D[155][j]] = 39680 + j, d[39680 + j] = D[155][j]);
    }
    ...
    for (j = 0; j != D[156].length; ++j) {
      65533 !== D[156][j].charCodeAt(0) && (e[D[156][j]] = 39936 + j, d[39936 + j] = D[156][j]);
    }
    ...
    for (j = 0; j != D[157].length; ++j) {
      65533 !== D[157][j].charCodeAt(0) && (e[D[157][j]] = 40192 + j, d[40192 + j] = D[157][j]);
    }
    ...
    for (j = 0; j != D[158].length; ++j) {
      65533 !== D[158][j].charCodeAt(0) && (e[D[158][j]] = 40448 + j, d[40448 + j] = D[158][j]);
    }
    ...
    for (j = 0; j != D[159].length; ++j) {
      65533 !== D[159][j].charCodeAt(0) && (e[D[159][j]] = 40704 + j, d[40704 + j] = D[159][j]);
    }
    ...
    for (j = 0; j != D[224].length; ++j) {
      65533 !== D[224][j].charCodeAt(0) && (e[D[224][j]] = 57344 + j, d[57344 + j] = D[224][j]);
    }
    ...
    for (j = 0; j != D[225].length; ++j) {
      65533 !== D[225][j].charCodeAt(0) && (e[D[225][j]] = 57600 + j, d[57600 + j] = D[225][j]);
    }
    ...
    for (j = 0; j != D[226].length; ++j) {
      65533 !== D[226][j].charCodeAt(0) && (e[D[226][j]] = 57856 + j, d[57856 + j] = D[226][j]);
    }
    ...
    for (j = 0; j != D[227].length; ++j) {
      65533 !== D[227][j].charCodeAt(0) && (e[D[227][j]] = 58112 + j, d[58112 + j] = D[227][j]);
    }
    ...
    for (j = 0; j != D[228].length; ++j) {
      65533 !== D[228][j].charCodeAt(0) && (e[D[228][j]] = 58368 + j, d[58368 + j] = D[228][j]);
    }
    ...
    for (j = 0; j != D[229].length; ++j) {
      65533 !== D[229][j].charCodeAt(0) && (e[D[229][j]] = 58624 + j, d[58624 + j] = D[229][j]);
    }
    ...
    for (j = 0; j != D[230].length; ++j) {
      65533 !== D[230][j].charCodeAt(0) && (e[D[230][j]] = 58880 + j, d[58880 + j] = D[230][j]);
    }
    ...
    for (j = 0; j != D[231].length; ++j) {
      65533 !== D[231][j].charCodeAt(0) && (e[D[231][j]] = 59136 + j, d[59136 + j] = D[231][j]);
    }
    ...
    for (j = 0; j != D[232].length; ++j) {
      65533 !== D[232][j].charCodeAt(0) && (e[D[232][j]] = 59392 + j, d[59392 + j] = D[232][j]);
    }
    ...
    for (j = 0; j != D[233].length; ++j) {
      65533 !== D[233][j].charCodeAt(0) && (e[D[233][j]] = 59648 + j, d[59648 + j] = D[233][j]);
    }
    ...
    for (j = 0; j != D[234].length; ++j) {
      65533 !== D[234][j].charCodeAt(0) && (e[D[234][j]] = 59904 + j, d[59904 + j] = D[234][j]);
    }
    ...
    for (j = 0; j != D[237].length; ++j) {
      65533 !== D[237][j].charCodeAt(0) && (e[D[237][j]] = 60672 + j, d[60672 + j] = D[237][j]);
    }
    ...
    for (j = 0; j != D[238].length; ++j) {
      65533 !== D[238][j].charCodeAt(0) && (e[D[238][j]] = 60928 + j, d[60928 + j] = D[238][j]);
    }
    ...
    for (j = 0; j != D[250].length; ++j) {
      65533 !== D[250][j].charCodeAt(0) && (e[D[250][j]] = 64000 + j, d[64000 + j] = D[250][j]);
    }
    ...
    for (j = 0; j != D[251].length; ++j) {
      65533 !== D[251][j].charCodeAt(0) && (e[D[251][j]] = 64256 + j, d[64256 + j] = D[251][j]);
    }
    D[252] = "����������������������������������������������������������������髜魵魲鮏鮱鮻鰀鵰鵫鶴鸙黑������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������".split("");
    for (j = 0; j != D[252].length; ++j) {
      65533 !== D[252][j].charCodeAt(0) && (e[D[252][j]] = 64512 + j, d[64512 + j] = D[252][j]);
    }
    return {enc:e, dec:d};
  }();
  cptable[936] = function() {
    var d = [], e = {}, D = [], j;
    D[0] = "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~€�������������������������������������������������������������������������������������������������������������������������������".split("");
    for (j = 0; j != D[0].length; ++j) {
      65533 !== D[0][j].charCodeAt(0) && (e[D[0][j]] = 0 + j, d[0 + j] = D[0][j]);
    }
    ...
    for (j = 0; j != D[133].length; ++j) {
      65533 !== D[133][j].charCodeAt(0) && (e[D[133][j]] = 34048 + j, d[34048 + j] = D[133][j]);
    }
    ...
    for (j = 0; j != D[134].length; ++j) {
      65533 !== D[134][j].charCodeAt(0) && (e[D[134][j]] = 34304 + j, d[34304 + j] = D[134][j]);
    }
    ...
    for (j = 0; j != D[160].length; ++j) {
      65533 !== D[160][j].charCodeAt(0) && (e[D[160][j]] = 40960 + j, d[40960 + j] = D[160][j]);
    }
    D[161] = "�����������������������������������������������������������������������������������������������������������������������������������������������������������������　、。·ˉˇ¨〃々—～‖…‘’“”〔〕〈〉《》「」『』〖〗【】±×÷∶∧∨∑∏∪∩∈∷√⊥∥∠⌒⊙∫∮≡≌≈∽∝≠≮≯≤≥∞∵∴♂♀°′″℃＄¤￠￡‰§№☆★○●◎◇◆□■△▲※→←↑↓〓�".split("");
    for (j = 0; j != D[161].length; ++j) {
      65533 !== D[161][j].charCodeAt(0) && (e[D[161][j]] = 41216 + j, d[41216 + j] = D[161][j]);
    }
    D[162] = "�����������������������������������������������������������������������������������������������������������������������������������������������������������������ⅰⅱⅲⅳⅴⅵⅶⅷⅸⅹ������⒈⒉⒊⒋⒌⒍⒎⒏⒐⒑⒒⒓⒔⒕⒖⒗⒘⒙⒚⒛⑴⑵⑶⑷⑸⑹⑺⑻⑼⑽⑾⑿⒀⒁⒂⒃⒄⒅⒆⒇①②③④⑤⑥⑦⑧⑨⑩��㈠㈡㈢㈣㈤㈥㈦㈧㈨㈩��ⅠⅡⅢⅣⅤⅥⅦⅧⅨⅩⅪⅫ���".split("");
    for (j = 0; j != D[162].length; ++j) {
      65533 !== D[162][j].charCodeAt(0) && (e[D[162][j]] = 41472 + j, d[41472 + j] = D[162][j]);
    }
    D[163] = "�����������������������������������������������������������������������������������������������������������������������������������������������������������������！＂＃￥％＆＇（）＊＋，－．／０１２３４５６７８９：；＜＝＞？＠ＡＢＣＤＥＦＧＨＩＪＫＬＭＮＯＰＱＲＳＴＵＶＷＸＹＺ［＼］＾＿｀ａｂｃｄｅｆｇｈｉｊｋｌｍｎｏｐｑｒｓｔｕｖｗｘｙｚ｛｜｝￣�".split("");
    for (j = 0; j != D[163].length; ++j) {
      65533 !== D[163][j].charCodeAt(0) && (e[D[163][j]] = 41728 + j, d[41728 + j] = D[163][j]);
    }
    D[164] = "�����������������������������������������������������������������������������������������������������������������������������������������������������������������ぁあぃいぅうぇえぉおかがきぎくぐけげこごさざしじすずせぜそぞただちぢっつづてでとどなにぬねのはばぱひびぴふぶぷへべぺほぼぽまみむめもゃやゅゆょよらりるれろゎわゐゑをん������������".split("");
    for (j = 0; j != D[164].length; ++j) {
      65533 !== D[164][j].charCodeAt(0) && (e[D[164][j]] = 41984 + j, d[41984 + j] = D[164][j]);
    }
    ...
    for (j = 0; j != D[170].length; ++j) {
      65533 !== D[170][j].charCodeAt(0) && (e[D[170][j]] = 43520 + j, d[43520 + j] = D[170][j]);
    }
    ...
    for (j = 0; j != D[171].length; ++j) {
      65533 !== D[171][j].charCodeAt(0) && (e[D[171][j]] = 43776 + j, d[43776 + j] = D[171][j]);
    }
    ...
    for (j = 0; j != D[172].length; ++j) {
      65533 !== D[172][j].charCodeAt(0) && (e[D[172][j]] = 44032 + j, d[44032 + j] = D[172][j]);
    }
    ...
    for (j = 0; j != D[173].length; ++j) {
      65533 !== D[173][j].charCodeAt(0) && (e[D[173][j]] = 44288 + j, d[44288 + j] = D[173][j]);
    }
    ...
    for (j = 0; j != D[174].length; ++j) {
      65533 !== D[174][j].charCodeAt(0) && (e[D[174][j]] = 44544 + j, d[44544 + j] = D[174][j]);
    }
    ...
    for (j = 0; j != D[175].length; ++j) {
      65533 !== D[175][j].charCodeAt(0) && (e[D[175][j]] = 44800 + j, d[44800 + j] = D[175][j]);
    }
    ...
    for (j = 0; j != D[176].length; ++j) {
      65533 !== D[176][j].charCodeAt(0) && (e[D[176][j]] = 45056 + j, d[45056 + j] = D[176][j]);
    }
    ...
    for (j = 0; j != D[177].length; ++j) {
      65533 !== D[177][j].charCodeAt(0) && (e[D[177][j]] = 45312 + j, d[45312 + j] = D[177][j]);
    }
    ...
    for (j = 0; j != D[178].length; ++j) {
      65533 !== D[178][j].charCodeAt(0) && (e[D[178][j]] = 45568 + j, d[45568 + j] = D[178][j]);
    }
    ...
    for (j = 0; j != D[179].length; ++j) {
      65533 !== D[179][j].charCodeAt(0) && (e[D[179][j]] = 45824 + j, d[45824 + j] = D[179][j]);
    }
    ...
    for (j = 0; j != D[180].length; ++j) {
      65533 !== D[180][j].charCodeAt(0) && (e[D[180][j]] = 46080 + j, d[46080 + j] = D[180][j]);
    }
    ...
    for (j = 0; j != D[181].length; ++j) {
      65533 !== D[181][j].charCodeAt(0) && (e[D[181][j]] = 46336 + j, d[46336 + j] = D[181][j]);
    }
    ...
    for (j = 0; j != D[182].length; ++j) {
      65533 !== D[182][j].charCodeAt(0) && (e[D[182][j]] = 46592 + j, d[46592 + j] = D[182][j]);
    }
    ...
    for (j = 0; j != D[183].length; ++j) {
      65533 !== D[183][j].charCodeAt(0) && (e[D[183][j]] = 46848 + j, d[46848 + j] = D[183][j]);
    }
    ...
    for (j = 0; j != D[184].length; ++j) {
      65533 !== D[184][j].charCodeAt(0) && (e[D[184][j]] = 47104 + j, d[47104 + j] = D[184][j]);
    }
    ...
    for (j = 0; j != D[185].length; ++j) {
      65533 !== D[185][j].charCodeAt(0) && (e[D[185][j]] = 47360 + j, d[47360 + j] = D[185][j]);
    }
    ...
    for (j = 0; j != D[186].length; ++j) {
      65533 !== D[186][j].charCodeAt(0) && (e[D[186][j]] = 47616 + j, d[47616 + j] = D[186][j]);
    }
    ...
    for (j = 0; j != D[187].length; ++j) {
      65533 !== D[187][j].charCodeAt(0) && (e[D[187][j]] = 47872 + j, d[47872 + j] = D[187][j]);
    }
    ...
    for (j = 0; j != D[188].length; ++j) {
      65533 !== D[188][j].charCodeAt(0) && (e[D[188][j]] = 48128 + j, d[48128 + j] = D[188][j]);
    }
    ...
    for (j = 0; j != D[189].length; ++j) {
      65533 !== D[189][j].charCodeAt(0) && (e[D[189][j]] = 48384 + j, d[48384 + j] = D[189][j]);
    }
    ...
    for (j = 0; j != D[190].length; ++j) {
      65533 !== D[190][j].charCodeAt(0) && (e[D[190][j]] = 48640 + j, d[48640 + j] = D[190][j]);
    }
    ...
    for (j = 0; j != D[191].length; ++j) {
      65533 !== D[191][j].charCodeAt(0) && (e[D[191][j]] = 48896 + j, d[48896 + j] = D[191][j]);
    }
    ...
    for (j = 0; j != D[192].length; ++j) {
      65533 !== D[192][j].charCodeAt(0) && (e[D[192][j]] = 49152 + j, d[49152 + j] = D[192][j]);
    }
    ...
    for (j = 0; j != D[193].length; ++j) {
      65533 !== D[193][j].charCodeAt(0) && (e[D[193][j]] = 49408 + j, d[49408 + j] = D[193][j]);
    }
    ...
    for (j = 0; j != D[194].length; ++j) {
      65533 !== D[194][j].charCodeAt(0) && (e[D[194][j]] = 49664 + j, d[49664 + j] = D[194][j]);
    }
    ...
    for (j = 0; j != D[195].length; ++j) {
      65533 !== D[195][j].charCodeAt(0) && (e[D[195][j]] = 49920 + j, d[49920 + j] = D[195][j]);
    }
    ...
    for (j = 0; j != D[196].length; ++j) {
      65533 !== D[196][j].charCodeAt(0) && (e[D[196][j]] = 50176 + j, d[50176 + j] = D[196][j]);
    }
    ...
    for (j = 0; j != D[197].length; ++j) {
      65533 !== D[197][j].charCodeAt(0) && (e[D[197][j]] = 50432 + j, d[50432 + j] = D[197][j]);
    }
    ...
    for (j = 0; j != D[198].length; ++j) {
      65533 !== D[198][j].charCodeAt(0) && (e[D[198][j]] = 50688 + j, d[50688 + j] = D[198][j]);
    }
    ...
    for (j = 0; j != D[199].length; ++j) {
      65533 !== D[199][j].charCodeAt(0) && (e[D[199][j]] = 50944 + j, d[50944 + j] = D[199][j]);
    }
    ...
    for (j = 0; j != D[200].length; ++j) {
      65533 !== D[200][j].charCodeAt(0) && (e[D[200][j]] = 51200 + j, d[51200 + j] = D[200][j]);
    }
    ...
    for (j = 0; j != D[201].length; ++j) {
      65533 !== D[201][j].charCodeAt(0) && (e[D[201][j]] = 51456 + j, d[51456 + j] = D[201][j]);
    }
    ...
    for (j = 0; j != D[202].length; ++j) {
      65533 !== D[202][j].charCodeAt(0) && (e[D[202][j]] = 51712 + j, d[51712 + j] = D[202][j]);
    }
    ...
    for (j = 0; j != D[203].length; ++j) {
      65533 !== D[203][j].charCodeAt(0) && (e[D[203][j]] = 51968 + j, d[51968 + j] = D[203][j]);
    }
    ...
    for (j = 0; j != D[204].length; ++j) {
      65533 !== D[204][j].charCodeAt(0) && (e[D[204][j]] = 52224 + j, d[52224 + j] = D[204][j]);
    }
    ...
    for (j = 0; j != D[205].length; ++j) {
      65533 !== D[205][j].charCodeAt(0) && (e[D[205][j]] = 52480 + j, d[52480 + j] = D[205][j]);
    }
    ...
    for (j = 0; j != D[206].length; ++j) {
      65533 !== D[206][j].charCodeAt(0) && (e[D[206][j]] = 52736 + j, d[52736 + j] = D[206][j]);
    }
    ...
    for (j = 0; j != D[207].length; ++j) {
      65533 !== D[207][j].charCodeAt(0) && (e[D[207][j]] = 52992 + j, d[52992 + j] = D[207][j]);
    }
    ...
    for (j = 0; j != D[208].length; ++j) {
      65533 !== D[208][j].charCodeAt(0) && (e[D[208][j]] = 53248 + j, d[53248 + j] = D[208][j]);
    }
    ...
    for (j = 0; j != D[209].length; ++j) {
      65533 !== D[209][j].charCodeAt(0) && (e[D[209][j]] = 53504 + j, d[53504 + j] = D[209][j]);
    }
    ...
    for (j = 0; j != D[210].length; ++j) {
      65533 !== D[210][j].charCodeAt(0) && (e[D[210][j]] = 53760 + j, d[53760 + j] = D[210][j]);
    }
    ...
    for (j = 0; j != D[211].length; ++j) {
      65533 !== D[211][j].charCodeAt(0) && (e[D[211][j]] = 54016 + j, d[54016 + j] = D[211][j]);
    }
    ...
    for (j = 0; j != D[212].length; ++j) {
      65533 !== D[212][j].charCodeAt(0) && (e[D[212][j]] = 54272 + j, d[54272 + j] = D[212][j]);
    }
    ...
    for (j = 0; j != D[213].length; ++j) {
      65533 !== D[213][j].charCodeAt(0) && (e[D[213][j]] = 54528 + j, d[54528 + j] = D[213][j]);
    }
    ...
    for (j = 0; j != D[214].length; ++j) {
      65533 !== D[214][j].charCodeAt(0) && (e[D[214][j]] = 54784 + j, d[54784 + j] = D[214][j]);
    }
    ...
    for (j = 0; j != D[215].length; ++j) {
      65533 !== D[215][j].charCodeAt(0) && (e[D[215][j]] = 55040 + j, d[55040 + j] = D[215][j]);
    }
    ...
    for (j = 0; j != D[216].length; ++j) {
      65533 !== D[216][j].charCodeAt(0) && (e[D[216][j]] = 55296 + j, d[55296 + j] = D[216][j]);
    }
    ...
    for (j = 0; j != D[217].length; ++j) {
      65533 !== D[217][j].charCodeAt(0) && (e[D[217][j]] = 55552 + j, d[55552 + j] = D[217][j]);
    }
    ...
    for (j = 0; j != D[218].length; ++j) {
      65533 !== D[218][j].charCodeAt(0) && (e[D[218][j]] = 55808 + j, d[55808 + j] = D[218][j]);
    }
    ...
    for (j = 0; j != D[219].length; ++j) {
      65533 !== D[219][j].charCodeAt(0) && (e[D[219][j]] = 56064 + j, d[56064 + j] = D[219][j]);
    }
    ...
    for (j = 0; j != D[220].length; ++j) {
      65533 !== D[220][j].charCodeAt(0) && (e[D[220][j]] = 56320 + j, d[56320 + j] = D[220][j]);
    }
    ...
    for (j = 0; j != D[221].length; ++j) {
      65533 !== D[221][j].charCodeAt(0) && (e[D[221][j]] = 56576 + j, d[56576 + j] = D[221][j]);
    }
    ...
    for (j = 0; j != D[222].length; ++j) {
      65533 !== D[222][j].charCodeAt(0) && (e[D[222][j]] = 56832 + j, d[56832 + j] = D[222][j]);
    }
    ...
    for (j = 0; j != D[223].length; ++j) {
      65533 !== D[223][j].charCodeAt(0) && (e[D[223][j]] = 57088 + j, d[57088 + j] = D[223][j]);
    }
    ...
    for (j = 0; j != D[235].length; ++j) {
      65533 !== D[235][j].charCodeAt(0) && (e[D[235][j]] = 60160 + j, d[60160 + j] = D[235][j]);
    }
    ...
    for (j = 0; j != D[236].length; ++j) {
      65533 !== D[236][j].charCodeAt(0) && (e[D[236][j]] = 60416 + j, d[60416 + j] = D[236][j]);
    }
    ...
    for (j = 0; j != D[239].length; ++j) {
      65533 !== D[239][j].charCodeAt(0) && (e[D[239][j]] = 61184 + j, d[61184 + j] = D[239][j]);
    }
    ...
    for (j = 0; j != D[240].length; ++j) {
      65533 !== D[240][j].charCodeAt(0) && (e[D[240][j]] = 61440 + j, d[61440 + j] = D[240][j]);
    }
    ...
    for (j = 0; j != D[241].length; ++j) {
      65533 !== D[241][j].charCodeAt(0) && (e[D[241][j]] = 61696 + j, d[61696 + j] = D[241][j]);
    }
    ...
    for (j = 0; j != D[242].length; ++j) {
      65533 !== D[242][j].charCodeAt(0) && (e[D[242][j]] = 61952 + j, d[61952 + j] = D[242][j]);
    }
    ...
    for (j = 0; j != D[243].length; ++j) {
      65533 !== D[243][j].charCodeAt(0) && (e[D[243][j]] = 62208 + j, d[62208 + j] = D[243][j]);
    }
    ...
    for (j = 0; j != D[244].length; ++j) {
      65533 !== D[244][j].charCodeAt(0) && (e[D[244][j]] = 62464 + j, d[62464 + j] = D[244][j]);
    }
    ...
    for (j = 0; j != D[245].length; ++j) {
      65533 !== D[245][j].charCodeAt(0) && (e[D[245][j]] = 62720 + j, d[62720 + j] = D[245][j]);
    }
    ...
    for (j = 0; j != D[246].length; ++j) {
      65533 !== D[246][j].charCodeAt(0) && (e[D[246][j]] = 62976 + j, d[62976 + j] = D[246][j]);
    }
    ...
    for (j = 0; j != D[247].length; ++j) {
      65533 !== D[247][j].charCodeAt(0) && (e[D[247][j]] = 63232 + j, d[63232 + j] = D[247][j]);
    }
    ...
    for (j = 0; j != D[248].length; ++j) {
      65533 !== D[248][j].charCodeAt(0) && (e[D[248][j]] = 63488 + j, d[63488 + j] = D[248][j]);
    }
    ...
    for (j = 0; j != D[249].length; ++j) {
      65533 !== D[249][j].charCodeAt(0) && (e[D[249][j]] = 63744 + j, d[63744 + j] = D[249][j]);
    }
    ...
    for (j = 0; j != D[253].length; ++j) {
      65533 !== D[253][j].charCodeAt(0) && (e[D[253][j]] = 64768 + j, d[64768 + j] = D[253][j]);
    }
    D[254] = "����������������������������������������������������������������兀嗀﨎﨏﨑﨓﨔礼﨟蘒﨡﨣﨤﨧﨨﨩��������������������������������������������������������������������������������������������������������������������������������������������������������������������������������".split("");
    for (j = 0; j != D[254].length; ++j) {
      65533 !== D[254][j].charCodeAt(0) && (e[D[254][j]] = 65024 + j, d[65024 + j] = D[254][j]);
    }
    return {enc:e, dec:d};
  }();
  ...
  cptable[1250] = function() {
    for (var D = [], e = {}, i = 0; 256 != i; ++i) {
      65533 !== "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~€�‚�„…†‡�‰Š‹ŚŤŽŹ�‘’“”•–—�™š›śťžź ˇ˘Ł¤Ą¦§¨©Ş«¬­®Ż°±˛ł´µ¶·¸ąş»Ľ˝ľżŔÁÂĂÄĹĆÇČÉĘËĚÍÎĎĐŃŇÓÔŐÖ×ŘŮÚŰÜÝŢßŕáâăäĺćçčéęëěíîďđńňóôőö÷řůúűüýţ˙".charCodeAt(i) && (e["\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~€�‚�„…†‡�‰Š‹ŚŤŽŹ�‘’“”•–—�™š›śťžź ˇ˘Ł¤Ą¦§¨©Ş«¬­®Ż°±˛ł´µ¶·¸ąş»Ľ˝ľżŔÁÂĂÄĹĆÇČÉĘËĚÍÎĎĐŃŇÓÔŐÖ×ŘŮÚŰÜÝŢßŕáâăäĺćçčéęëěíîďđńňóôőö÷řůúűüýţ˙".charAt(i)] = 
      i), D[i] = "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~€�‚�„…†‡�‰Š‹ŚŤŽŹ�‘’“”•–—�™š›śťžź ˇ˘Ł¤Ą¦§¨©Ş«¬­®Ż°±˛ł´µ¶·¸ąş»Ľ˝ľżŔÁÂĂÄĹĆÇČÉĘËĚÍÎĎĐŃŇÓÔŐÖ×ŘŮÚŰÜÝŢßŕáâăäĺćçčéęëěíîďđńňóôőö÷řůúűüýţ˙".charAt(i);
    }
    return {enc:e, dec:D};
  }();
  cptable[1251] = function() {
    for (var D = [], e = {}, i = 0; 256 != i; ++i) {
      65533 !== "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ЂЃ‚ѓ„…†‡€‰Љ‹ЊЌЋЏђ‘’“”•–—�™љ›њќћџ ЎўЈ¤Ґ¦§Ё©Є«¬­®Ї°±Ііґµ¶·ё№є»јЅѕїАБВГДЕЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯабвгдежзийклмнопрстуфхцчшщъыьэюя".charCodeAt(i) && (e["\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ЂЃ‚ѓ„…†‡€‰Љ‹ЊЌЋЏђ‘’“”•–—�™љ›њќћџ ЎўЈ¤Ґ¦§Ё©Є«¬­®Ї°±Ііґµ¶·ё№є»јЅѕїАБВГДЕЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯабвгдежзийклмнопрстуфхцчшщъыьэюя".charAt(i)] = 
      i), D[i] = "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ЂЃ‚ѓ„…†‡€‰Љ‹ЊЌЋЏђ‘’“”•–—�™љ›њќћџ ЎўЈ¤Ґ¦§Ё©Є«¬­®Ї°±Ііґµ¶·ё№є»јЅѕїАБВГДЕЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯабвгдежзийклмнопрстуфхцчшщъыьэюя".charAt(i);
    }
    return {enc:e, dec:D};
  }();
  cptable[1252] = function() {
    for (var D = [], e = {}, i = 0; 256 != i; ++i) {
      65533 !== "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~€�‚ƒ„…†‡ˆ‰Š‹Œ�Ž��‘’“”•–—˜™š›œ�žŸ ¡¢£¤¥¦§¨©ª«¬­®¯°±²³´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜÝÞßàáâãäåæçèéêëìíîïðñòóôõö÷øùúûüýþÿ".charCodeAt(i) && (e["\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~€�‚ƒ„…†‡ˆ‰Š‹Œ�Ž��‘’“”•–—˜™š›œ�žŸ ¡¢£¤¥¦§¨©ª«¬­®¯°±²³´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜÝÞßàáâãäåæçèéêëìíîïðñòóôõö÷øùúûüýþÿ".charAt(i)] = 
      i), D[i] = "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~€�‚ƒ„…†‡ˆ‰Š‹Œ�Ž��‘’“”•–—˜™š›œ�žŸ ¡¢£¤¥¦§¨©ª«¬­®¯°±²³´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜÝÞßàáâãäåæçèéêëìíîïðñòóôõö÷øùúûüýþÿ".charAt(i);
    }
    return {enc:e, dec:D};
  }();
  cptable[1253] = function() {
    for (var D = [], e = {}, i = 0; 256 != i; ++i) {
      65533 !== "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~€�‚ƒ„…†‡�‰�‹�����‘’“”•–—�™�›���� ΅Ά£¤¥¦§¨©�«¬­®―°±²³΄µ¶·ΈΉΊ»Ό½ΎΏΐΑΒΓΔΕΖΗΘΙΚΛΜΝΞΟΠΡ�ΣΤΥΦΧΨΩΪΫάέήίΰαβγδεζηθικλμνξοπρςστυφχψωϊϋόύώ�".charCodeAt(i) && (e["\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~€�‚ƒ„…†‡�‰�‹�����‘’“”•–—�™�›���� ΅Ά£¤¥¦§¨©�«¬­®―°±²³΄µ¶·ΈΉΊ»Ό½ΎΏΐΑΒΓΔΕΖΗΘΙΚΛΜΝΞΟΠΡ�ΣΤΥΦΧΨΩΪΫάέήίΰαβγδεζηθικλμνξοπρςστυφχψωϊϋόύώ�".charAt(i)] = 
      i), D[i] = "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~€�‚ƒ„…†‡�‰�‹�����‘’“”•–—�™�›���� ΅Ά£¤¥¦§¨©�«¬­®―°±²³΄µ¶·ΈΉΊ»Ό½ΎΏΐΑΒΓΔΕΖΗΘΙΚΛΜΝΞΟΠΡ�ΣΤΥΦΧΨΩΪΫάέήίΰαβγδεζηθικλμνξοπρςστυφχψωϊϋόύώ�".charAt(i);
    }
    return {enc:e, dec:D};
  }();
  cptable[1254] = function() {
    for (var D = [], e = {}, i = 0; 256 != i; ++i) {
      65533 !== "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~€�‚ƒ„…†‡ˆ‰Š‹Œ����‘’“”•–—˜™š›œ��Ÿ ¡¢£¤¥¦§¨©ª«¬­®¯°±²³´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏĞÑÒÓÔÕÖ×ØÙÚÛÜİŞßàáâãäåæçèéêëìíîïğñòóôõö÷øùúûüışÿ".charCodeAt(i) && (e["\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~€�‚ƒ„…†‡ˆ‰Š‹Œ����‘’“”•–—˜™š›œ��Ÿ ¡¢£¤¥¦§¨©ª«¬­®¯°±²³´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏĞÑÒÓÔÕÖ×ØÙÚÛÜİŞßàáâãäåæçèéêëìíîïğñòóôõö÷øùúûüışÿ".charAt(i)] = 
      i), D[i] = "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~€�‚ƒ„…†‡ˆ‰Š‹Œ����‘’“”•–—˜™š›œ��Ÿ ¡¢£¤¥¦§¨©ª«¬­®¯°±²³´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏĞÑÒÓÔÕÖ×ØÙÚÛÜİŞßàáâãäåæçèéêëìíîïğñòóôõö÷øùúûüışÿ".charAt(i);
    }
    return {enc:e, dec:D};
  }();
  cptable[1255] = function() {
    for (var D = [], e = {}, i = 0; 256 != i; ++i) {
      65533 !== "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~€�‚ƒ„…†‡ˆ‰�‹�����‘’“”•–—˜™�›���� ¡¢£₪¥¦§¨©×«¬­®¯°±²³´µ¶·¸¹÷»¼½¾¿ְֱֲֳִֵֶַָֹ�ֻּֽ־ֿ׀ׁׂ׃װױײ׳״�������אבגדהוזחטיךכלםמןנסעףפץצקרשת��‎‏�".charCodeAt(i) && (e["\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~€�‚ƒ„…†‡ˆ‰�‹�����‘’“”•–—˜™�›���� ¡¢£₪¥¦§¨©×«¬­®¯°±²³´µ¶·¸¹÷»¼½¾¿ְֱֲֳִֵֶַָֹ�ֻּֽ־ֿ׀ׁׂ׃װױײ׳״�������אבגדהוזחטיךכלםמןנסעףפץצקרשת��‎‏�".charAt(i)] = 
      i), D[i] = "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~€�‚ƒ„…†‡ˆ‰�‹�����‘’“”•–—˜™�›���� ¡¢£₪¥¦§¨©×«¬­®¯°±²³´µ¶·¸¹÷»¼½¾¿ְֱֲֳִֵֶַָֹ�ֻּֽ־ֿ׀ׁׂ׃װױײ׳״�������אבגדהוזחטיךכלםמןנסעףפץצקרשת��‎‏�".charAt(i);
    }
    return {enc:e, dec:D};
  }();
  cptable[1256] = function() {
    for (var D = [], e = {}, i = 0; 256 != i; ++i) {
      65533 !== "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~€پ‚ƒ„…†‡ˆ‰ٹ‹Œچژڈگ‘’“”•–—ک™ڑ›œ‌‍ں ،¢£¤¥¦§¨©ھ«¬­®¯°±²³´µ¶·¸¹؛»¼½¾؟ہءآأؤإئابةتثجحخدذرزسشصض×طظعغـفقكàلâمنهوçèéêëىيîïًٌٍَôُِ÷ّùْûü‎‏ے".charCodeAt(i) && (e["\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~€پ‚ƒ„…†‡ˆ‰ٹ‹Œچژڈگ‘’“”•–—ک™ڑ›œ‌‍ں ،¢£¤¥¦§¨©ھ«¬­®¯°±²³´µ¶·¸¹؛»¼½¾؟ہءآأؤإئابةتثجحخدذرزسشصض×طظعغـفقكàلâمنهوçèéêëىيîïًٌٍَôُِ÷ّùْûü‎‏ے".charAt(i)] = 
      i), D[i] = "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~€پ‚ƒ„…†‡ˆ‰ٹ‹Œچژڈگ‘’“”•–—ک™ڑ›œ‌‍ں ،¢£¤¥¦§¨©ھ«¬­®¯°±²³´µ¶·¸¹؛»¼½¾؟ہءآأؤإئابةتثجحخدذرزسشصض×طظعغـفقكàلâمنهوçèéêëىيîïًٌٍَôُِ÷ّùْûü‎‏ے".charAt(i);
    }
    return {enc:e, dec:D};
  }();
  cptable[1257] = function() {
    for (var D = [], e = {}, i = 0; 256 != i; ++i) {
      65533 !== "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~€�‚�„…†‡�‰�‹�¨ˇ¸�‘’“”•–—�™�›�¯˛� �¢£¤�¦§Ø©Ŗ«¬­®Æ°±²³´µ¶·ø¹ŗ»¼½¾æĄĮĀĆÄÅĘĒČÉŹĖĢĶĪĻŠŃŅÓŌÕÖ×ŲŁŚŪÜŻŽßąįāćäåęēčéźėģķīļšńņóōõö÷ųłśūüżž˙".charCodeAt(i) && (e["\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~€�‚�„…†‡�‰�‹�¨ˇ¸�‘’“”•–—�™�›�¯˛� �¢£¤�¦§Ø©Ŗ«¬­®Æ°±²³´µ¶·ø¹ŗ»¼½¾æĄĮĀĆÄÅĘĒČÉŹĖĢĶĪĻŠŃŅÓŌÕÖ×ŲŁŚŪÜŻŽßąįāćäåęēčéźėģķīļšńņóōõö÷ųłśūüżž˙".charAt(i)] = 
      i), D[i] = "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~€�‚�„…†‡�‰�‹�¨ˇ¸�‘’“”•–—�™�›�¯˛� �¢£¤�¦§Ø©Ŗ«¬­®Æ°±²³´µ¶·ø¹ŗ»¼½¾æĄĮĀĆÄÅĘĒČÉŹĖĢĶĪĻŠŃŅÓŌÕÖ×ŲŁŚŪÜŻŽßąįāćäåęēčéźėģķīļšńņóōõö÷ųłśūüżž˙".charAt(i);
    }
    return {enc:e, dec:D};
  }();
  cptable[1258] = function() {
    for (var D = [], e = {}, i = 0; 256 != i; ++i) {
      65533 !== "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~€�‚ƒ„…†‡ˆ‰�‹Œ����‘’“”•–—˜™�›œ��Ÿ ¡¢£¤¥¦§¨©ª«¬­®¯°±²³´µ¶·¸¹º»¼½¾¿ÀÁÂĂÄÅÆÇÈÉÊË̀ÍÎÏĐÑ̉ÓÔƠÖ×ØÙÚÛÜỮßàáâăäåæçèéêë́íîïđṇ̃óôơö÷øùúûüư₫ÿ".charCodeAt(i) && (e["\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~€�‚ƒ„…†‡ˆ‰�‹Œ����‘’“”•–—˜™�›œ��Ÿ ¡¢£¤¥¦§¨©ª«¬­®¯°±²³´µ¶·¸¹º»¼½¾¿ÀÁÂĂÄÅÆÇÈÉÊË̀ÍÎÏĐÑ̉ÓÔƠÖ×ØÙÚÛÜỮßàáâăäåæçèéêë́íîïđṇ̃óôơö÷øùúûüư₫ÿ".charAt(i)] = 
      i), D[i] = "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~€�‚ƒ„…†‡ˆ‰�‹Œ����‘’“”•–—˜™�›œ��Ÿ ¡¢£¤¥¦§¨©ª«¬­®¯°±²³´µ¶·¸¹º»¼½¾¿ÀÁÂĂÄÅÆÇÈÉÊË̀ÍÎÏĐÑ̉ÓÔƠÖ×ØÙÚÛÜỮßàáâăäåæçèéêë́íîïđṇ̃óôơö÷øùúûüư₫ÿ".charAt(i);
    }
    return {enc:e, dec:D};
  }();
  cptable[10000] = function() {
    for (var D = [], e = {}, i = 0; 256 != i; ++i) {
      65533 !== "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ÄÅÇÉÑÖÜáàâäãåçéèêëíìîïñóòôöõúùûü†°¢£§•¶ß®©™´¨≠ÆØ∞±≤≥¥µ∂∑∏π∫ªºΩæø¿¡¬√ƒ≈∆«»… ÀÃÕŒœ–—“”‘’÷◊ÿŸ⁄¤‹›ﬁﬂ‡·‚„‰ÂÊÁËÈÍÎÏÌÓÔ�ÒÚÛÙıˆ˜¯˘˙˚¸˝˛ˇ".charCodeAt(i) && (e["\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ÄÅÇÉÑÖÜáàâäãåçéèêëíìîïñóòôöõúùûü†°¢£§•¶ß®©™´¨≠ÆØ∞±≤≥¥µ∂∑∏π∫ªºΩæø¿¡¬√ƒ≈∆«»… ÀÃÕŒœ–—“”‘’÷◊ÿŸ⁄¤‹›ﬁﬂ‡·‚„‰ÂÊÁËÈÍÎÏÌÓÔ�ÒÚÛÙıˆ˜¯˘˙˚¸˝˛ˇ".charAt(i)] = 
      i), D[i] = "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ÄÅÇÉÑÖÜáàâäãåçéèêëíìîïñóòôöõúùûü†°¢£§•¶ß®©™´¨≠ÆØ∞±≤≥¥µ∂∑∏π∫ªºΩæø¿¡¬√ƒ≈∆«»… ÀÃÕŒœ–—“”‘’÷◊ÿŸ⁄¤‹›ﬁﬂ‡·‚„‰ÂÊÁËÈÍÎÏÌÓÔ�ÒÚÛÙıˆ˜¯˘˙˚¸˝˛ˇ".charAt(i);
    }
    return {enc:e, dec:D};
  }();
  cptable[10006] = function() {
    for (var D = [], e = {}, i = 0; 256 != i; ++i) {
      65533 !== "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~Ä¹²É³ÖÜ΅àâä΄¨çéèêë£™îï•½‰ôö¦­ùûü†ΓΔΘΛΞΠß®©ΣΪ§≠°·Α±≤≥¥ΒΕΖΗΙΚΜΦΫΨΩάΝ¬ΟΡ≈Τ«»… ΥΧΆΈœ–―“”‘’÷ΉΊΌΎέήίόΏύαβψδεφγηιξκλμνοπώρστθωςχυζϊϋΐΰ�".charCodeAt(i) && (e["\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~Ä¹²É³ÖÜ΅àâä΄¨çéèêë£™îï•½‰ôö¦­ùûü†ΓΔΘΛΞΠß®©ΣΪ§≠°·Α±≤≥¥ΒΕΖΗΙΚΜΦΫΨΩάΝ¬ΟΡ≈Τ«»… ΥΧΆΈœ–―“”‘’÷ΉΊΌΎέήίόΏύαβψδεφγηιξκλμνοπώρστθωςχυζϊϋΐΰ�".charAt(i)] = 
      i), D[i] = "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~Ä¹²É³ÖÜ΅àâä΄¨çéèêë£™îï•½‰ôö¦­ùûü†ΓΔΘΛΞΠß®©ΣΪ§≠°·Α±≤≥¥ΒΕΖΗΙΚΜΦΫΨΩάΝ¬ΟΡ≈Τ«»… ΥΧΆΈœ–―“”‘’÷ΉΊΌΎέήίόΏύαβψδεφγηιξκλμνοπώρστθωςχυζϊϋΐΰ�".charAt(i);
    }
    return {enc:e, dec:D};
  }();
  cptable[10007] = function() {
    for (var D = [], e = {}, i = 0; 256 != i; ++i) {
      65533 !== "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~АБВГДЕЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯ†°¢£§•¶І®©™Ђђ≠Ѓѓ∞±≤≥іµ∂ЈЄєЇїЉљЊњјЅ¬√ƒ≈∆«»… ЋћЌќѕ–—“”‘’÷„ЎўЏџ№Ёёяабвгдежзийклмнопрстуфхцчшщъыьэю¤".charCodeAt(i) && (e["\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~АБВГДЕЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯ†°¢£§•¶І®©™Ђђ≠Ѓѓ∞±≤≥іµ∂ЈЄєЇїЉљЊњјЅ¬√ƒ≈∆«»… ЋћЌќѕ–—“”‘’÷„ЎўЏџ№Ёёяабвгдежзийклмнопрстуфхцчшщъыьэю¤".charAt(i)] = 
      i), D[i] = "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~АБВГДЕЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯ†°¢£§•¶І®©™Ђђ≠Ѓѓ∞±≤≥іµ∂ЈЄєЇїЉљЊњјЅ¬√ƒ≈∆«»… ЋћЌќѕ–—“”‘’÷„ЎўЏџ№Ёёяабвгдежзийклмнопрстуфхцчшщъыьэю¤".charAt(i);
    }
    return {enc:e, dec:D};
  }();
  ...
  cptable[10029] = function() {
    for (var D = [], e = {}, i = 0; 256 != i; ++i) {
      65533 !== "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ÄĀāÉĄÖÜáąČäčĆćéŹźĎíďĒēĖóėôöõúĚěü†°Ę£§•¶ß®©™ę¨≠ģĮįĪ≤≥īĶ∂∑łĻļĽľĹĺŅņŃ¬√ńŇ∆«»… ňŐÕőŌ–—“”‘’÷◊ōŔŕŘ‹›řŖŗŠ‚„šŚśÁŤťÍŽžŪÓÔūŮÚůŰűŲųÝýķŻŁżĢˇ".charCodeAt(i) && (e["\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ÄĀāÉĄÖÜáąČäčĆćéŹźĎíďĒēĖóėôöõúĚěü†°Ę£§•¶ß®©™ę¨≠ģĮįĪ≤≥īĶ∂∑łĻļĽľĹĺŅņŃ¬√ńŇ∆«»… ňŐÕőŌ–—“”‘’÷◊ōŔŕŘ‹›řŖŗŠ‚„šŚśÁŤťÍŽžŪÓÔūŮÚůŰűŲųÝýķŻŁżĢˇ".charAt(i)] = 
      i), D[i] = "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ÄĀāÉĄÖÜáąČäčĆćéŹźĎíďĒēĖóėôöõúĚěü†°Ę£§•¶ß®©™ę¨≠ģĮįĪ≤≥īĶ∂∑łĻļĽľĹĺŅņŃ¬√ńŇ∆«»… ňŐÕőŌ–—“”‘’÷◊ōŔŕŘ‹›řŖŗŠ‚„šŚśÁŤťÍŽžŪÓÔūŮÚůŰűŲųÝýķŻŁżĢˇ".charAt(i);
    }
    return {enc:e, dec:D};
  }();
  cptable[10079] = function() {
    for (var D = [], e = {}, i = 0; 256 != i; ++i) {
      65533 !== "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ÄÅÇÉÑÖÜáàâäãåçéèêëíìîïñóòôöõúùûüÝ°¢£§•¶ß®©™´¨≠ÆØ∞±≤≥¥µ∂∑∏π∫ªºΩæø¿¡¬√ƒ≈∆«»… ÀÃÕŒœ–—“”‘’÷◊ÿŸ⁄¤ÐðÞþý·‚„‰ÂÊÁËÈÍÎÏÌÓÔ�ÒÚÛÙıˆ˜¯˘˙˚¸˝˛ˇ".charCodeAt(i) && (e["\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ÄÅÇÉÑÖÜáàâäãåçéèêëíìîïñóòôöõúùûüÝ°¢£§•¶ß®©™´¨≠ÆØ∞±≤≥¥µ∂∑∏π∫ªºΩæø¿¡¬√ƒ≈∆«»… ÀÃÕŒœ–—“”‘’÷◊ÿŸ⁄¤ÐðÞþý·‚„‰ÂÊÁËÈÍÎÏÌÓÔ�ÒÚÛÙıˆ˜¯˘˙˚¸˝˛ˇ".charAt(i)] = 
      i), D[i] = "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ÄÅÇÉÑÖÜáàâäãåçéèêëíìîïñóòôöõúùûüÝ°¢£§•¶ß®©™´¨≠ÆØ∞±≤≥¥µ∂∑∏π∫ªºΩæø¿¡¬√ƒ≈∆«»… ÀÃÕŒœ–—“”‘’÷◊ÿŸ⁄¤ÐðÞþý·‚„‰ÂÊÁËÈÍÎÏÌÓÔ�ÒÚÛÙıˆ˜¯˘˙˚¸˝˛ˇ".charAt(i);
    }
    return {enc:e, dec:D};
  }();
  cptable[10081] = function() {
    for (var D = [], e = {}, i = 0; 256 != i; ++i) {
      65533 !== "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ÄÅÇÉÑÖÜáàâäãåçéèêëíìîïñóòôöõúùûü†°¢£§•¶ß®©™´¨≠ÆØ∞±≤≥¥µ∂∑∏π∫ªºΩæø¿¡¬√ƒ≈∆«»… ÀÃÕŒœ–—“”‘’÷◊ÿŸĞğİıŞş‡·‚„‰ÂÊÁËÈÍÎÏÌÓÔ�ÒÚÛÙ�ˆ˜¯˘˙˚¸˝˛ˇ".charCodeAt(i) && (e["\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ÄÅÇÉÑÖÜáàâäãåçéèêëíìîïñóòôöõúùûü†°¢£§•¶ß®©™´¨≠ÆØ∞±≤≥¥µ∂∑∏π∫ªºΩæø¿¡¬√ƒ≈∆«»… ÀÃÕŒœ–—“”‘’÷◊ÿŸĞğİıŞş‡·‚„‰ÂÊÁËÈÍÎÏÌÓÔ�ÒÚÛÙ�ˆ˜¯˘˙˚¸˝˛ˇ".charAt(i)] = 
      i), D[i] = "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ÄÅÇÉÑÖÜáàâäãåçéèêëíìîïñóòôöõúùûü†°¢£§•¶ß®©™´¨≠ÆØ∞±≤≥¥µ∂∑∏π∫ªºΩæø¿¡¬√ƒ≈∆«»… ÀÃÕŒœ–—“”‘’÷◊ÿŸĞğİıŞş‡·‚„‰ÂÊÁËÈÍÎÏÌÓÔ�ÒÚÛÙ�ˆ˜¯˘˙˚¸˝˛ˇ".charAt(i);
    }
    return {enc:e, dec:D};
  }();
  cptable[28591] = function() {
    for (var D = [], e = {}, i = 0; 256 != i; ++i) {
      65533 !== "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ ¡¢£¤¥¦§¨©ª«¬­®¯°±²³´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜÝÞßàáâãäåæçèéêëìíîïðñòóôõö÷øùúûüýþÿ".charCodeAt(i) && (e["\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ ¡¢£¤¥¦§¨©ª«¬­®¯°±²³´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜÝÞßàáâãäåæçèéêëìíîïðñòóôõö÷øùúûüýþÿ".charAt(i)] = 
      i), D[i] = "\x00\b\t\n\v\f\r !\"#$%\x26'()*+,-./0123456789:;\x3c\x3d\x3e?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ ¡¢£¤¥¦§¨©ª«¬­®¯°±²³´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜÝÞßàáâãäåæçèéêëìíîïðñòóôõö÷øùúûüýþÿ".charAt(i);
    }
    return {enc:e, dec:D};
  }();
  "undefined" !== typeof module && module.exports && "undefined" === typeof DO_NOT_EXPORT_CODEPAGE && (module.exports = cptable);
  (function(root, factory) {
    if ("undefined" === typeof cptable) {
      if ("undefined" !== typeof require) {
        var cpt = cptable;
        "undefined" !== typeof module && module.exports && "undefined" === typeof DO_NOT_EXPORT_CODEPAGE ? module.exports = factory(cpt) : root.cptable = factory(cpt);
      } else {
        throw Error("cptable not found");
      }
    } else {
      cptable = factory(cptable);
    }
  })(this, function(cpt) {
    var magic = {1200:"utf16le", 1201:"utf16be", 12E3:"utf32le", 12001:"utf32be", 16969:"utf64le", 20127:"ascii", 65E3:"utf7", 65001:"utf8"}, sbcs_cache = [874, 1250, 1251, 1252, 1253, 1254, 1255, 1256, 10000], dbcs_cache = [932, 936, 949, 950], magic_cache = [65001], magic_decode = {}, magic_encode = {}, cpdcache = {}, cpecache = {}, sfcc = function(x) {
      return String.fromCharCode(x);
    }, cca = function(x) {
      return x.charCodeAt(0);
    }, has_buf = "undefined" !== typeof Buffer, Buffer_from = function() {
    };
    if (has_buf) {
      ...
      Buffer.allocUnsafe || (Buffer.allocUnsafe = function(n) {
        return new Buffer(n);
      });
      var mdl = 1024, mdb = Buffer.allocUnsafe(mdl), make_EE = function(E) {
        for (var EE = Buffer.allocUnsafe(65536), i = 0; 65536 > i; ++i) {
          EE[i] = 0;
        }
        i = Object.keys(E);
        for (var len = i.length, ee = 0, e; ee < len; ++ee) {
          if (e = i[ee]) {
            EE[e.charCodeAt(0)] = E[e];
          }
        }
        return EE;
      }, sbcs_encode = function(cp) {
        var EE = make_EE(cpt[cp].enc);
        return function(data, ofmt) {
          var len = data.length, i, j;
          if ("string" === typeof data) {
            ...
            for (i = j = 0; i < len; ++i) {
              var D = data[i];
              128 > D ? out[j++] = EE[D] : 224 > D ? (out[j++] = EE[((D & 31) << 6) + (data[i + 1] & 63)], ++i) : 240 > D ? (out[j++] = EE[((D & 15) << 12) + ((data[i + 1] & 63) << 6) + (data[i + 2] & 63)], i += 2) : (D = ((D & 7) << 18) + ((data[i + 1] & 63) << 12) + ((data[i + 2] & 63) << 6) + (data[i + 3] & 63), i += 3, 65536 > D ? out[j++] = EE[D] : (D -= 65536, out[j++] = EE[55296 + (D >> 10 & 1023)], out[j++] = EE[56320 + (D & 1023)]));
            }
            out = out.slice(0, j);
          } else {
          ...
          return ofmt && "buf" !== ofmt ? "arr" !== ofmt ? out.toString("binary") : [].slice.call(out) : out;
        };
      }, sbcs_decode = function(cp) {
        cp = cpt[cp].dec;
        var DD = Buffer.allocUnsafe(131072), d = 0, c = "";
        for (d = 0; d < cp.length; ++d) {
          if (c = cp[d]) {
            c = c.charCodeAt(0), DD[2 * d] = c & 255, DD[2 * d + 1] = c >> 8;
          }
        }
        return function(data) {
          var len = data.length, i;
          2 * len > mdl && (mdl = 2 * len, mdb = Buffer.allocUnsafe(mdl));
          if (Buffer.isBuffer(data)) {
            ...
            for (i = 0; i < len; i++) {
              j = 2 * data.charCodeAt(i), mdb[2 * i] = DD[j], mdb[2 * i + 1] = DD[j + 1];
            }
          } else {
            for (i = 0; i < len; i++) {
              j = 2 * data[i], mdb[2 * i] = DD[j], mdb[2 * i + 1] = DD[j + 1];
            }
          }
          return mdb.slice(0, 2 * len).toString("ucs2");
        };
      }, dbcs_encode = function(cp) {
        cp = cpt[cp].enc;
        for (var EE = Buffer.allocUnsafe(131072), i = 0; 131072 > i; ++i) {
          EE[i] = 0;
        }
        i = Object.keys(cp);
        for (var ee = 0, e = i[ee]; ee < i.length; ++ee) {
          if (e = i[ee]) {
        ...
        return function(data, ofmt) {
          var len = data.length, out = Buffer.allocUnsafe(2 * len), i, k;
          if ("string" === typeof data) {
            for (i = k = 0; i < len; ++i) {
              var j = 2 * data.charCodeAt(i);
              out[k++] = EE[j + 1] || EE[j];
              0 < EE[j + 1] && (out[k++] = EE[j]);
            }
            out = out.slice(0, k);
            ...
            for (i = k = 0; i < len; ++i) {
              j = data[i];
              128 > j || (224 > j ? (j = ((j & 31) << 6) + (data[i + 1] & 63), ++i) : 240 > j ? (j = ((j & 15) << 12) + ((data[i + 1] & 63) << 6) + (data[i + 2] & 63), i += 2) : (j = ((j & 7) << 18) + ((data[i + 1] & 63) << 12) + ((data[i + 2] & 63) << 6) + (data[i + 3] & 63), i += 3));
              if (65536 > j) {
                j *= 2;
              } else {
                var jj = j - 65536;
            ...
            for (i = k = 0; i < len; i++) {
              j = 2 * data[i].charCodeAt(0), out[k++] = EE[j + 1] || EE[j], 0 < EE[j + 1] && (out[k++] = EE[j]);
            }
          }
          return ofmt && "buf" !== ofmt ? "arr" !== ofmt ? out.toString("binary") : [].slice.call(out) : out;
        };
      }, dbcs_decode = function(cp) {
        cp = cpt[cp].dec;
        var DD = Buffer.allocUnsafe(131072), d = 0, c, j = c = 0;
        for (d = d = 0; 65536 > d; ++d) {
          DD[2 * d] = 255, DD[2 * d + 1] = 253;
        }
        for (d = 0; d < cp.length; ++d) {
          if (c = cp[d]) {
            c = c.charCodeAt(0), j = 2 * d, DD[j] = c & 255, DD[j + 1] = c >> 8;
          }
        }
        return function(data) {
          var len = data.length, out = Buffer.allocUnsafe(2 * len), i, k = 0;
          if (Buffer.isBuffer(data)) {
            for (i = 0; i < len; i++) {
              var j = 2 * data[i];
              255 === DD[j] && 253 === DD[j + 1] && (j = 2 * ((data[i] << 8) + data[i + 1]), ++i);
              out[k++] = DD[j];
              out[k++] = DD[j + 1];
            }
          } else if ("string" === typeof data) {
            for (i = 0; i < len; i++) {
              j = 2 * data.charCodeAt(i), 255 === DD[j] && 253 === DD[j + 1] && (j = 2 * ((data.charCodeAt(i) << 8) + data.charCodeAt(i + 1)), ++i), out[k++] = DD[j], out[k++] = DD[j + 1];
            }
          } else {
            for (i = 0; i < len; i++) {
              j = 2 * data[i], 255 === DD[j] && 253 === DD[j + 1] && (j = 2 * ((data[i] << 8) + data[i + 1]), ++i), out[k++] = DD[j], out[k++] = DD[j + 1];
            }
          }
      ...
      magic_decode[65001] = function utf8_d(data) {
        ...
        var len = data.length;
        4 * len > mdl && (mdl = 4 * len, mdb = Buffer.allocUnsafe(mdl));
        var i = 0;
        3 <= len && 239 == data[0] && 187 == data[1] && 191 == data[2] && (i = 3);
        for (var j, k = 0; i < len; i += j) {
          j = 1;
          var w = data[i];
          128 > w || (224 > w ? (w = 64 * (w & 31) + (data[i + 1] & 63), j = 2) : 240 > w ? (w = ((w & 15) << 12) + 64 * (data[i + 1] & 63) + (data[i + 2] & 63), j = 3) : (w = 262144 * (w & 7) + ((data[i + 1] & 63) << 12) + 64 * (data[i + 2] & 63) + (data[i + 3] & 63), j = 4));
          if (65536 > w) {
            mdb[k++] = w & 255, mdb[k++] = w >> 8;
          } else {
            w -= 65536;
            var ww = 55296 + (w >> 10 & 1023);
            w = 56320 + (w & 1023);
            mdb[k++] = ww & 255;
            mdb[k++] = ww >>> 8;
            mdb[k++] = w & 255;
      ...
      magic_encode[65001] = function(data, ofmt) {
        if (has_buf && Buffer.isBuffer(data)) {
          return ofmt && "buf" !== ofmt ? "arr" !== ofmt ? data.toString("binary") : [].slice.call(data) : data;
        }
        var len = data.length, j = 0, direct = "string" === typeof data;
        4 * len > mdl && (mdl = 4 * len, mdb = Buffer.allocUnsafe(mdl));
        for (var i = 0; i < len; ++i) {
          var w = direct ? data.charCodeAt(i) : data[i].charCodeAt(0);
          127 >= w ? mdb[j++] = w : 2047 >= w ? (mdb[j++] = 192 + (w >> 6), mdb[j++] = 128 + (w & 63)) : 55296 <= w && 57343 >= w ? (w -= 55296, ++i, w = (direct ? data.charCodeAt(i) : data[i].charCodeAt(0)) - 56320 + (w << 10), mdb[j++] = 240 + (w >>> 18 & 7), mdb[j++] = 144 + (w >>> 12 & 63), mdb[j++] = 128 + (w >>> 6 & 63), mdb[j++] = 128 + (w & 63)) : (mdb[j++] = 224 + (w >> 12), mdb[j++] = 128 + (w >> 6 & 63), mdb[j++] = 128 + (w & 63));
        }
        return ofmt && "buf" !== ofmt ? "arr" !== ofmt ? mdb.slice(0, j).toString("binary") : [].slice.call(mdb, 0, j) : mdb.slice(0, j);
      };
    }
    nbfs = function() {
      if (has_buf && !cpdcache[sbcs_cache[0]]) {
        var i;
        for (i = 0; i < sbcs_cache.length; ++i) {
          var s = sbcs_cache[i];
          cpt[s] && (cpdcache[s] = sbcs_decode(s), cpecache[s] = sbcs_encode(s));
        }
        for (i = 0; i < dbcs_cache.length; ++i) {
          s = dbcs_cache[i], cpt[s] && (cpdcache[s] = dbcs_decode(s), cpecache[s] = dbcs_encode(s));
        }
        for (i = 0; i < magic_cache.length; ++i) {
          s = magic_cache[i], magic_decode[s] && (cpdcache[s] = magic_decode[s]), magic_encode[s] && (cpecache[s] = magic_encode[s]);
        }
      }
    };
    var null_enc = function(data, ofmt) {
      return "";
    }, cp_decache = function(cp) {
      delete cpdcache[cp];
      delete cpecache[cp];
    }, cache = {encache:nbfs, decache:function() {
      if (has_buf) {
      ...
      last_enc = null_enc;
      last_cp = 0;
    }, sbcs:sbcs_cache, dbcs:dbcs_cache};
    nbfs();
    var last_enc = null_enc, last_cp = 0;
    cpt.utils = {decode:function decode(cp, data) {
      var F;
      if (F = cpdcache[cp]) {
        return F(data);
      }
      ...
      F = data.length;
      var out = Array(F), s, w, i = 0, k = 0;
      if ((s = cpt[cp]) && (w = s.dec)) {
        for (i = 0; i < F; i += cp) {
          cp = 2;
          s = w[(data[i] << 8) + data[i + 1]];
          s || (cp = 1, s = w[data[i]]);
          if (!s) {
            throw Error("Unrecognized code: " + data[i] + " " + data[i + cp - 1] + " " + i + " " + cp + " " + w[data[i]]);
          }
          out[k++] = s;
        }
      } else if (w = magic[cp]) {
        switch(w) {
          case "utf8":
            for (3 <= F && 239 == data[0] && 187 == data[1] && 191 == data[2] && (i = 3); i < F; i += cp) {
              cp = 1, 128 > data[i] ? w = data[i] : 224 > data[i] ? (w = 64 * (data[i] & 31) + (data[i + 1] & 63), cp = 2) : 240 > data[i] ? (w = ((data[i] & 15) << 12) + 64 * (data[i + 1] & 63) + (data[i + 2] & 63), cp = 3) : (w = 262144 * (data[i] & 7) + ((data[i + 1] & 63) << 12) + 64 * (data[i + 2] & 63) + (data[i + 3] & 63), cp = 4), 65536 > w || (w -= 65536, s = 55296 + (w >> 10 & 1023), w = 56320 + (w & 1023), out[k++] = String.fromCharCode(s)), out[k++] = String.fromCharCode(w);
            }
            break;
          case "ascii":
            if (has_buf && Buffer.isBuffer(data)) {
              return data.toString(w);
            }
            for (i = 0; i < F; i++) {
          ...
          case "utf16le":
            ...
            break;
          case "utf16be":
            2 <= F && 254 == data[0] && 255 == data[1] && (i = 2);
            for (cp = 2; i + 1 < F; i += cp) {
              out[k++] = String.fromCharCode((data[i] << 8) + data[i + 1]);
            }
            break;
          case "utf32le":
            4 <= F && 255 == data[0] && 254 == data[1] && 0 === data[2] && 0 === data[3] && (i = 4);
            for (cp = 4; i < F; i += cp) {
              w = (data[i + 3] << 24) + (data[i + 2] << 16) + (data[i + 1] << 8) + data[i], 65535 < w ? (w -= 65536, out[k++] = String.fromCharCode(55296 + (w >> 10 & 1023)), out[k++] = String.fromCharCode(56320 + (w & 1023))) : out[k++] = String.fromCharCode(w);
            }
            break;
          case "utf32be":
            4 <= F && 255 == data[3] && 254 == data[2] && 0 === data[1] && 0 === data[0] && (i = 4);
            for (cp = 4; i < F; i += cp) {
              w = (data[i] << 24) + (data[i + 1] << 16) + (data[i + 2] << 8) + data[i + 3], 65535 < w ? (w -= 65536, out[k++] = String.fromCharCode(55296 + (w >> 10 & 1023)), out[k++] = String.fromCharCode(56320 + (w & 1023))) : out[k++] = String.fromCharCode(w);
            }
            break;
          case "utf7":
            if (4 <= F && 43 == data[0] && 47 == data[1] && 118 == data[2]) {
              if (5 <= F && 56 == data[3] && 45 == data[4]) {
                i = 5;
              } else if (56 == data[3] || 57 == data[3] || 43 == data[3] || 47 == data[3]) {
                i = 4;
              }
            }
            for (; i < F; i += cp) {
              if (43 !== data[i]) {
                cp = 1, out[k++] = String.fromCharCode(data[i]);
              } else {
                if (cp = 1, 45 === data[i + 1]) {
                  cp = 2, out[k++] = "+";
                } else {
                  for (; String.fromCharCode(data[i + cp]).match(/[A-Za-z0-9+\/]/);) {
                    cp++;
                  }
                  s = 0;
                  45 === data[i + cp] && (++cp, s = 1);
                  var tt = [];
                  for (w = 1; w < cp - s;) {
                    var c1 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".indexOf(String.fromCharCode(data[i + w++]));
                    var c2 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".indexOf(String.fromCharCode(data[i + w++]));
                    c1 = c1 << 2 | c2 >> 4;
                    tt.push(c1);
                    c1 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".indexOf(String.fromCharCode(data[i + w++]));
                    if (-1 === c1) {
                      break;
                    }
                    c2 = (c2 & 15) << 4 | c1 >> 2;
                    tt.push(c2);
                    c2 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".indexOf(String.fromCharCode(data[i + w++]));
                    if (-1 === c2) {
                      break;
                    }
                    c1 = (c1 & 3) << 6 | c2;
            ...
            break;
          default:
            throw Error("Unsupported magic: " + cp + " " + magic[cp]);
        }
      } else {
        throw Error("Unrecognized CP: " + cp);
      }
      ...
      if (cpecache[cp]) {
        return last_enc = cpecache[last_cp = cp], last_enc(data, ofmt);
      }
      has_buf && Buffer.isBuffer(data) && (data = data.toString("utf8"));
      var len = data.length, out = has_buf ? Buffer.allocUnsafe(4 * len) : [], j = 0, ww;
      var w = cpt[cp];
      var isstr = "string" === typeof data;
      if (w && (ww = w.enc)) {
        for (cp = 0; cp < len; ++cp, ++j) {
          w = ww[isstr ? data.charAt(cp) : data[cp]], 255 < w ? (out[j] = w >> 8, out[++j] = w & 255) : out[j] = w & 255;
        }
      } else if (ww = magic[cp]) {
        switch(ww) {
          case "utf8":
            if (has_buf && isstr) {
              out = Buffer_from(data, ww);
              j = out.length;
              break;
            }
            for (cp = 0; cp < len; ++cp, ++j) {
              w = isstr ? data.charCodeAt(cp) : data[cp].charCodeAt(0), 127 >= w ? out[j] = w : 2047 >= w ? (out[j] = 192 + (w >> 6), out[++j] = 128 + (w & 63)) : 55296 <= w && 57343 >= w ? (w -= 55296, ww = (isstr ? data.charCodeAt(++cp) : data[++cp].charCodeAt(0)) - 56320 + (w << 10), out[j] = 240 + (ww >>> 18 & 7), out[++j] = 144 + (ww >>> 12 & 63), out[++j] = 128 + (ww >>> 6 & 63), out[++j] = 128 + (ww & 63)) : (out[j] = 224 + (w >> 12), out[++j] = 128 + (w >> 6 & 63), out[++j] = 128 + (w & 63));
            }
            break;
          case "ascii":
            ...
            for (cp = 0; cp < len; ++cp, ++j) {
              if (w = isstr ? data.charCodeAt(cp) : data[cp].charCodeAt(0), 127 >= w) {
                out[j] = w;
              } else {
                throw Error("bad ascii " + w);
              }
            }
            break;
          case "utf16le":
            ...
            for (cp = 0; cp < len; ++cp) {
              w = isstr ? data.charCodeAt(cp) : data[cp].charCodeAt(0), out[j++] = w & 255, out[j++] = w >> 8;
            }
            break;
          case "utf16be":
            for (cp = 0; cp < len; ++cp) {
              w = isstr ? data.charCodeAt(cp) : data[cp].charCodeAt(0), out[j++] = w >> 8, out[j++] = w & 255;
            }
            break;
          case "utf32le":
            for (cp = 0; cp < len; ++cp) {
              w = isstr ? data.charCodeAt(cp) : data[cp].charCodeAt(0), 55296 <= w && 57343 >= w && (w = 65536 + (w - 55296 << 10) + (data[++cp].charCodeAt(0) - 56320)), out[j++] = w & 255, w >>= 8, out[j++] = w & 255, w >>= 8, out[j++] = w & 255, w >>= 8, out[j++] = w & 255;
            }
            break;
          case "utf32be":
            for (cp = 0; cp < len; ++cp) {
              w = isstr ? data.charCodeAt(cp) : data[cp].charCodeAt(0), 55296 <= w && 57343 >= w && (w = 65536 + (w - 55296 << 10) + (data[++cp].charCodeAt(0) - 56320)), out[j + 3] = w & 255, w >>= 8, out[j + 2] = w & 255, w >>= 8, out[j + 1] = w & 255, w >>= 8, out[j] = w & 255, j += 4;
            }
            break;
          case "utf7":
            for (cp = 0; cp < len; cp++) {
              ww = isstr ? data.charAt(cp) : data[cp].charAt(0), "+" === ww ? (out[j++] = 43, out[j++] = 45) : -1 < "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789'(),-./:?".indexOf(ww) ? out[j++] = ww.charCodeAt(0) : (ww = encode(1201, ww), out[j++] = 43, out[j++] = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charCodeAt(ww[0] >> 2), out[j++] = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charCodeAt(((ww[0] & 3) << 4) + ((ww[1] || 0) >> 
              4)), out[j++] = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charCodeAt(((ww[1] & 15) << 2) + ((ww[2] || 0) >> 6)), out[j++] = 45);
            }
            break;
          default:
            throw Error("Unsupported magic: " + cp + " " + magic[cp]);
      ...
      out = out.slice(0, j);
      return has_buf ? ofmt && "buf" !== ofmt ? "arr" !== ofmt ? out.toString("binary") : [].slice.call(out) : out : "str" == ofmt ? out.map(sfcc).join("") : out;
    }, hascp:function(cp) {
...
//# sourceMappingURL=module$node_modules$xlsx$dist$cpexcel.js.map
